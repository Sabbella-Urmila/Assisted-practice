...
public class SigninPage {
	...
	driver.findElement(By.id("ap_email")).sendKeys("admin123@gmail.com" );
		driver.findElement(By.xpath("//input[@id='continue']")).click();
		
		// inspect password input box and click on sign button
		
		driver.findElement(By.id("ap_password")).sendKeys("password@1234");
...
public class SearchProduct {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@class='asection'])[2]/descendant::span[11]")).click();
